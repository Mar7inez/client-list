...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> listarClientePorId(@PathVariable Long id){
        Cliente cliente = clienteRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("El cliente con el "+ id + " no existe"));
    ...
    public ResponseEntity<Cliente> actualizarCliente(@PathVariable Long id,
        ...
        Cliente cliente = clienteRepository.findById(id)
                                           .orElseThrow(()-> new ResourceNotFoundException("El cliente con el "+ id + " no existe"));
